...
1. Run `database/schema.sql` to create the tables (`users`, `questions`, `submissions`, `question_sessions`, `mock_interviews`).
2. Run `database/triggers.sql` to set up the automated triggers.
